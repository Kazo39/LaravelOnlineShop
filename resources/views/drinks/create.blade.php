                    ...
                    <div class="card-body">
                        <form action="{{route('drink.store')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <input type="text" class="form-control" name="type" placeholder="Enter drink type">
                                    @error('type')
                                    <div class="row">
                                        <div class="alert alert-danger col-10 offset-1 mt-1">{{$message}}</div>
                                    </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-6 ">
                                    <input type="text" class="form-control" name="price" placeholder="Enter drink price">
                                    @error('price')
                                    <div class="row">
                                        <div class="alert alert-danger col-10 offset-1 mt-1">{{$message}}</div>
                                    </div>
                                ...
                                <div class="col-6 ">
                                    <input type="text" class="form-control" name="weight" placeholder="Enter drink weight(in liter)">
                                    @error('weight')
                                    <div class="row">
                                        <div class="alert alert-danger col-10 offset-1 mt-1">{{$message}}</div>
                                    </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-8 offset-2">
                                    <input type="file" name="drink_photo" class="form-control">
                                    @error('drink_photo')
                                    <div class="row">
                                        <div class="alert alert-danger col-10 offset-1 mt-1">{{$message}}</div>
                                    </div>
