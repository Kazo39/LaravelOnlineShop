        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('addition.snacks.add')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row mt-3">
                                <div class="col-6">
                            ...
                            <div class="row mt-5 border border-2">
                                <div class="row ">
                                    ...
                                    <div class="col-4 border-end ">Price</div>
                                    <div class="col-4 ">Product</div>
                                </div>
                                @foreach($additions as $add)
                                    <div class="row mt-3">
                                        <div class="col-4 border-end">{{$add->name}}</div>
                                        <div class="col-4 border-end">{{$add->price}}€</div>
                                        <div class="col-4 ">{{$add->taggable->name}}</div>
                                    </div>
                                @endforeach
                            </div>
                        </form>
